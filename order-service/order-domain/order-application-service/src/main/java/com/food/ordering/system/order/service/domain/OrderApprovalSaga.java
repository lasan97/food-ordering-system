...
public class OrderApprovalSaga implements SagaStep<RestaurantApprovalResponse> {
	...
	public void rollback(RestaurantApprovalResponse restaurantApprovalResponse) {
		...
		paymentOutboxHelper.savePaymentOutboxMessage(orderDateMapper.orderCancelledEventToOrderPaymentEventPayload(domainEvent),
	...
	private OrderPaymentOutboxMessage getUpdatedPaymentOutboxMessage(String sagaId, OrderStatus orderStatus, SagaStatus sagaStatus) {
		...
		if(orderPaymentOutboxMessageResponse.isEmpty()) {
			throw new DomainException("Payment outbox message cannot be found in "
